        ...
        <div class="container">
            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">La categoria <%= categoria.getNombre()%> se ve interesante </p>
                    <a href="SubCategoria.jsp?idcat=<%= categoria.getIdCategoria()%>" class="btn btn-primary">Click</a>
                </div>
            </div>
            <%
                }
