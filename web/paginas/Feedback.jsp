            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <%
                        ...
                        List<FeedBack> feedbacks = daofb.obtenerFeedBack(IdUser);
                        
                        // Iteramos sobre la lista de categoria y generamos un <div> para cada una
                        for (FeedBack feedback : feedbacks) {
                    %>
                    <tr>
                        <th scope="row"><%= feedback.getIdFeed()%></th>
                        <td><%= feedback.getNombre()%></td>
                        <td><%= feedback.getDireccion()%></td>
                        <td><%= feedback.getFecha()%></td>
                        <td><a href="Elejido.jsp?id=<%= feedback.getIdReco()%>" class="btn btn-primary">Click</a></td>
                    </tr>
                    <%
                        }
                    %>
